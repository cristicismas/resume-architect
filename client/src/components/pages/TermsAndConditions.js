...
const TermsAndConditions = () => {
  return (
    <section id="terms-and-conditions">
      ...
      <p>Welcome to Resume Architect!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of
        https://resumearchitect.herokuapp.com's Website, located at https://resumearchitect.herokuapp.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use Resume
        Architect if you do not agree to take all of the terms and conditions stated on this page. Our Terms and
      ...
      <p>
        We employ the use of cookies. By accessing Resume Architect, you agreed to use cookies in agreement with the
        https://resumearchitect.herokuapp.com's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, https://resumearchitect.herokuapp.com and/or its licensors own the intellectual
        property rights for all material on Resume Architect. All intellectual property rights are reserved. You may
        access this from Resume Architect for your own personal use subjected to restrictions set in these terms and
        conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Resume Architect</li>
        <li>Sell, rent or sub-license material from Resume Architect</li>
        <li>Reproduce, duplicate or copy material from Resume Architect</li>
        <li>Redistribute content from Resume Architect</li>
      </ul>
      ...
      <p>
        ...
        areas of the website. https://resumearchitect.herokuapp.com does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the views and opinions of
        https://resumearchitect.herokuapp.com,its agents and/or affiliates. Comments reflect the views and opinions of
        the person who post their views and opinions. To the extent permitted by applicable laws,
        https://resumearchitect.herokuapp.com shall not be liable for the Comments or for any liability, damages or
        expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
        this website.
      </p>

      <p>
        https://resumearchitect.herokuapp.com reserves the right to monitor all Comments and to remove any Comments
      ...
      <p>
        You hereby grant https://resumearchitect.herokuapp.com a non-exclusive license to use, reproduce, edit and
      ...
      <p>
        ...
        https://resumearchitect.herokuapp.com; and (d) the link is in the context of general resource information.
      </p>
      ...
      <p>
        ...
        you must inform us by sending an e-mail to https://resumearchitect.herokuapp.com. Please include your name, your
      ...
      <p>
        No use of https://resumearchitect.herokuapp.com's logo or other artwork will be allowed for linking absent a
